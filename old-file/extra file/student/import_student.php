...
require 'C:\xampp\htdocs\FUTURE\config\db_config.php';
...
if (isset($_POST['import'])) {
	...
	try {
		...
		// header('Location: FUTURE/bsit-student.php'); // Redirect to the same page
		exit();
	...
	<table class="table">
		...
		<?php foreach ($data as $row) : ?>
			<tr>
				...
				<td>
					<a class="cell" class="btn btn-info view-btn" data-toggle="modal" data-target="#viewModal<?php echo $row['STUDENT_ID']; ?>">View</a>
					<a class="btn btn-warning edit-btn" data-toggle="modal" data-target="#editModal<?php echo $row['STUDENT_ID']; ?>">Edit</a>
