        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="viewModalLabel<?php echo $row['id_user']; ?>">View Student Details</h5>
                ...
                <div class="modal-body">
                    ...
                    <table>
                        ...
                        <p>Middlename: <?php echo $row['middlename']; ?></p>
                ...
                <div class="modal-footer">
                    <a href="view_user.php?id=<?php echo $row['id_user']; ?>" class="btn btn-primary">Edit</a> <!-- Changed from "Save to Docs" to "View" -->
